...
namespace Musicefy.Converters
{
    ...
    public class SearchModeIconConverter : IValueConverter
    {
        ...
        // Cache parsed Geometry objects to avoid re-parsing on every call
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[SearchModeIconConverter] Error parsing geometry: {ex.Message}");
            }
